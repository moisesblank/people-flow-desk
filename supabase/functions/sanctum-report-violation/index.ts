...
serve(async (req: Request) => {
  ...
  try {
    // ============================================
    // 0) INICIALIZAR SUPABASE (necessário para rate limit)
    // ============================================
    ...
    // ============================================
    // 0.1) RATE LIMIT CHECK (antes de processar)
    // ============================================
    ...
    // 🛡️ PATCH-P1-001: Verificar rate limit PERSISTENTE (DB)
    ...
    // supabase já criado acima (seção 0)
