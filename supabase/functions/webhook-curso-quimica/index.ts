// ============================================
// 🚨 WEBHOOK-CURSO-QUIMICA → DEPRECADO → 410 GONE
...
serve(async (req) => {
  ...
  console.log('[webhook-curso-quimica] 🚨 DEPRECATED - Endpoint desativado. Use webhook-handler.');
  ...
  return new Response(
    JSON.stringify({
      ...
      migration: {
        old_endpoint: '/functions/v1/webhook-curso-quimica',
