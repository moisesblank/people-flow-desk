-- ============================================
-- 🔐 AJUSTE: Trust de dispositivo para 7 dias
-- ============================================

-- Recriar função register_device_mfa_verification com 7 dias
...
BEGIN
    ...
    -- Inserir nova verificação com 7 DIAS de validade
...
'Registra verificação MFA de dispositivo com validade de 7 dias';