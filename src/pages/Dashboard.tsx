...
import { processarDadosDashboard } from "@/services/dashboardService";
...
export default function Dashboard() {
  ...
  // ============================================
  // PROCESSAMENTO DE DADOS VIA SERVICE LAYER
  // Substituiu 138 linhas de useMemo inline
  // ============================================
  const processedData = useMemo(() => {
    if (!stats) return null;
    return processarDadosDashboard({
      income: stats.income,
      personalExpenses: stats.personalExpenses,
      companyExpenses: stats.companyExpenses,
      pendingPayments: stats.pendingPayments,
      sitePendencias: stats.sitePendencias,
      students: stats.students,
      affiliates: stats.affiliates,
      pendingTasks: stats.pendingTasks,
      tasksData: stats.tasksData,
      incomeData: stats.incomeData,
      personalExtraData: stats.personalExtraData,
    });
  }, [stats]);
  ...
  return (
    ...
    <div className="p-4 md:p-6 lg:p-8">
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        {/* PLANILHA VIVA: Barra de métricas em tempo real */}
        <ReactiveMetricsBar />
