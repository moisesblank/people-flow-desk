...
const ROLE_CONFIG: Record<AppRole, { label: string; icon: typeof Crown; color: string; description: string }> = {
  owner: {
    label: "Proprietário",
    icon: Crown,
    color: "text-role-owner bg-role-owner/10 border-role-owner/20",
    description: "Acesso total ao sistema. Pode gerenciar usuários, permissões e todas as configurações.",
  },
  admin: {
    label: "Administrador",
    icon: Shield,
    color: "text-role-admin bg-role-admin/10 border-role-admin/20",
    description: "Acesso administrativo completo, exceto áreas pessoais do owner.",
  },
  coordenacao: {
    label: "Coordenação",
    icon: UserCog,
    color: "text-role-coordenacao bg-role-coordenacao/10 border-role-coordenacao/20",
    description: "Gerencia equipe, turmas e planejamento de aulas.",
  },
  suporte: {
    label: "Suporte",
    icon: Headphones,
    color: "text-role-suporte bg-role-suporte/10 border-role-suporte/20",
    description: "Atendimento ao aluno e gestão do portal.",
  },
  monitoria: {
    label: "Monitoria",
    icon: GraduationCap,
    color: "text-role-monitoria bg-role-monitoria/10 border-role-monitoria/20",
    description: "Acompanhamento de alunos, turmas e simulados.",
  },
  afiliado: {
    label: "Afiliados",
    icon: Users2,
    color: "text-role-afiliado bg-role-afiliado/10 border-role-afiliado/20",
    description: "Gestão de afiliados e métricas de vendas.",
  },
  marketing: {
    label: "Marketing",
    icon: TrendingUp,
    color: "text-role-marketing bg-role-marketing/10 border-role-marketing/20",
    description: "Marketing, lançamentos e gestão do site.",
  },
  contabilidade: {
    label: "Contabilidade",
    icon: Calculator,
    color: "text-role-contabilidade bg-role-contabilidade/10 border-role-contabilidade/20",
    description: "Acesso às finanças da empresa (visualização).",
  },
  employee: {
    label: "Administrativo",
    icon: Briefcase,
    color: "text-role-employee bg-role-employee/10 border-role-employee/20",
