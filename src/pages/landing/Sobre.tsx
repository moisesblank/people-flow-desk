// ============================================
// PÁGINA DEDICADA: SOBRE O PROFESSOR
// URL: /sobre
// Fragmento da Home - Seção do Professor
// ============================================
...
const Sobre = () => {
  return (
    <>
      <Helmet>
        <title>Sobre o Prof. Moisés Medeiros | Química que Aprova</title>
        <meta name="description" content="Conheça o Prof. Moisés Medeiros, mestre em Química pela UFRN com +15 anos de experiência. O professor que mais aprova em Medicina no Brasil." />
      </Helmet>
