  ...
  const chemistryFlashcards = [
    {
      ...
      verso: "É o número de prótons no núcleo de um átomo. Define qual elemento químico é.",
      dificuldade: "facil" as const,
    },
    {
      id: "2",
      frente: "Qual a diferença entre ligação iônica e covalente?",
      verso:
        "Iônica: transferência de elétrons (metal + não-metal). Covalente: compartilhamento de elétrons (não-metais).",
      dificuldade: "medio" as const,
    },
    {
      id: "3",
      frente: "O que é eletronegatividade?",
      verso: "Capacidade de um átomo atrair elétrons em uma ligação química. Flúor é o mais eletronegativo.",
      dificuldade: "medio" as const,
    },
    {
      id: "4",
      frente: "Como calcular o nox de um elemento?",
      verso: "Regras: H=+1, O=-2, metais alcalinos=+1, soma dos nox = carga total.",
      dificuldade: "dificil" as const,
    },
    {
      id: "5",
      frente: "O que é hibridização sp³?",
      verso: "Mistura de 1 orbital s + 3 orbitais p, formando 4 orbitais híbridos equivalentes com ângulo de 109,5°.",
      dificuldade: "dificil" as const,
    },
    {
      id: "6",
      frente: "Qual a fórmula da velocidade de reação?",
      verso: "v = k[A]^m[B]^n, onde k é a constante de velocidade e m,n são as ordens da reação.",
      dificuldade: "dificil" as const,
    },
  ];
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        >
          <div>
            ...
            <p className="text-muted-foreground mt-1">Plataforma LMS completa - Curso de Química v7.0</p>
          </div>
              ...
              <CardContent>
                {loading ? (
                  ...
                  <div className="py-12 text-center">
                    ...
                    <p className="text-muted-foreground">Ajuste os filtros ou adicione novos alunos</p>
                  </div>
                ) : (
                        ...
                        <div key={course} className="space-y-2">
                          <div className="flex justify-between text-sm">
                            ...
                            <span className="text-muted-foreground">
                              {count} alunos ({percentage.toFixed(0)}%)
                            </span>
                          </div>
            ...
            <div className="grid gap-6 lg:grid-cols-2">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Assista às aulas com recursos de anotações</CardDescription>
                </CardHeader>
                <CardContent>
          ...
          <TabsContent value="flashcards" className="mt-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Revise os conceitos principais com cartões interativos</CardDescription>
              </CardHeader>
              <CardContent>
                <Flashcard
                  cards={chemistryFlashcards}
                  onComplete={(results) =>
                    toast.success(`Concluído! Acertos: ${results.correct}, Erros: ${results.incorrect}`)
                  }
                />
              </CardContent>
            </Card>
