...
export const CLOUDFLARE_EXPRESSIONS_REFERENCE = {
  cacheRules: {
    ...
    B4_manifest: `(http.host eq "pro.moisesmedeiros.com.br" and http.request.uri.path in {"/manifest.json" "/favicon.png"})`,
  },
  
  firewallRules: {
    F1_allow_assets: `(http.host eq "pro.moisesmedeiros.com.br" and (http.request.uri.path starts_with "/assets/" or http.request.uri.path in {"/sw.js" "/manifest.json" "/favicon.png"}))`,
