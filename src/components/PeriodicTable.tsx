        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
          <DialogTrigger asChild>
            <Button
              variant="ghost"
              size="icon"
              className="h-9 w-9 hover:bg-red-500/20 transition-all duration-200 group"
              title="Tabela Periódica"
            >
              <Atom className="h-5 w-5 text-red-400 group-hover:text-red-300 group-hover:scale-110 group-hover:rotate-180 transition-all duration-500" />
            </Button>
          </DialogTrigger>
