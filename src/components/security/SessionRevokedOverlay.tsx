        ...
        >
          ...
          >
            ...
            <div className="bg-gradient-to-b from-card to-card/95 border border-destructive/30 rounded-2xl p-8 shadow-2xl shadow-destructive/20">
              ...
              >
                Por segurança, permitimos apenas <span className="text-foreground font-medium">uma sessão ativa</span> por vez. 
                Esta sessão foi encerrada porque você fez login em outro aparelho.
              </motion.p>
