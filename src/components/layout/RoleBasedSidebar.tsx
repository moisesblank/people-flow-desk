...
const gestaoMenuGroups: MenuGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Erro Questão", url: "/gestaofc/questoeserrosdomoisa", icon: Stethoscope, area: "questoes", badge: "FIX", textColor: "text-red-500" },
...
const alunoMenuGroups: MenuGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Meu Planer", url: "/alunos/planer", icon: CalendarDays, area: "aluno-cronograma", badge: "NOVO" },
