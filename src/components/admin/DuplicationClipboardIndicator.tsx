  ...
  return (
    <AnimatePresence mode="wait">
      ...
      <motion.div
        ...
        className={cn("fixed bottom-8 right-8 z-50 cursor-grab active:cursor-grabbing", "select-none")}
      >
        {isMinimized ? (
          // === VERSÃO MINIMIZADA ===
          <motion.div
            ...
            <div className="p-4 space-y-4">
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="font-bold text-white text-base truncate">{clipboardItem.entityName}</p>
                    <div className="flex items-center gap-2 mt-1">
                      <Badge variant="outline" className="text-xs bg-primary/20 text-primary border-primary/30">
                        {entityLabel}
                      </Badge>
                      <span className="text-xs text-muted-foreground">há {formatTime(timeSinceCopy)}</span>
                    </div>
                  </div>
                </div>
              </motion.div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="p-3 rounded-lg bg-slate-800/50 border border-slate-700">
                  ...
                  <p className="text-[10px] text-muted-foreground">Arraste este card</p>
                </div>
              </div>
