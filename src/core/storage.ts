...
export interface BucketDefinition {
  ...
  public: boolean; // Legado - usar accessLevel
  maxFileSize: number;
  ...
  allowedRoles: string[];
  isPremium: boolean; // Requer role beta/owner
  isProtected: boolean; // Aplica SANCTUM protection
...
export const BUCKETS = {
  ...
  ENA_ASSETS_TRANSMUTED: "ena-assets-transmuted", // Páginas rasterizadas
  ENA_ASSETS_ENCRYPTED: "ena-assets-encrypted",   // Conteúdo criptografado
