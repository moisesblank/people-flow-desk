...
| Portal Aluno | `/alunos/*` | beta, aluno_gratuito, owner | alunoRoutes.tsx |
...
MAPEAMENTO:
  ...
  aluno_presencial: "/alunos/dashboard"
  beta_expira: "/alunos/dashboard"
...
```yaml
# Arquivo: src/core/urlAccessControl.ts (OWNER_ONLY_PATHS)
...
```yaml
# Arquivo: src/core/urlAccessControl.ts (PUBLIC_PATHS)
...
```yaml
# Arquivo: src/routes/legacyRoutes.tsx

COMPORTAMENTO: "Todas redirecionam para / (home)"
MOTIVO: "Não expor /gestaofc como destino"
...
ROTAS_BLOQUEADAS:
  ...
  - /funcionarios
  - /calendario
  - Todas as rotas antigas de gestão
```
...
FLUXO_NOVO_LOGIN:
  ...
  5. Redirect para área apropriada
```
...
**FIM — CONSTITUIÇÃO SYNAPSE Ω v10.4**

**Status:** VIGENTE E IMUTÁVEL  
**Autoridade:** OWNER (moisesblank@gmail.com)  
**Data:** 2026-01-06  
**Assinatura Digital:** SYNAPSE Ω v10.4.0
